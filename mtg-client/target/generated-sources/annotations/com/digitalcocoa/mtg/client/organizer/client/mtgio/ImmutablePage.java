...
public final class ImmutablePage implements Page {
  ...
  public final ImmutablePage withNextPageNumber(int value) {
    ...
    return new ImmutablePage(newValue, this.lastPageNumber, this.cards);
  }
  ...
  public final ImmutablePage withNextPageNumber(Optional<Integer> optional) {
    ...
    return new ImmutablePage(value, this.lastPageNumber, this.cards);
  }
  ...
  public final ImmutablePage withLastPageNumber(Integer value) {
    ...
    if (this.lastPageNumber.equals(newValue)) return this;
    return new ImmutablePage(this.nextPageNumber, newValue, this.cards);
  }
  ...
  private boolean equalTo(ImmutablePage another) {
    return Objects.equals(nextPageNumber, another.nextPageNumber)
        && lastPageNumber.equals(another.lastPageNumber)
        && cards.equals(another.cards);
  }

  /**
   * Computes a hash code from attributes: {@code nextPageNumber}, {@code lastPageNumber}, {@code cards}.
  ...
  public static final class Builder {
    ...
    public ImmutablePage build() {
      ...
      return new ImmutablePage(nextPageNumber, lastPageNumber, createUnmodifiableList(true, cards));
    }
